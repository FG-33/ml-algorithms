...
class MyTestCase(unittest.TestCase):
    def test_something1(self):
        """ Check if data correctly extracts the 5 row 2 column data from testdata1.txt """
        x, y = load_data("testdata1.txt")
        self.assertEqual((5, 1), x.shape)
        self.assertEqual((5, 1), y.shape)

    def test_something2(self):
        """ Check if data correctly extracts the 5 row 3 column data from testdata1.txt """
